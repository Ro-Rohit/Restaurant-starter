...
const Newsletter = () => {
  ...
  return (
    <section className='bg-none  lg:bg-newsletter  lg:bg-cover lg:h-[220px] lg:bg-center lg:px-24 xl:bg-auto'>
      <div className='flex flex-col lg:flex-row items-center   justify-between h-full'>
        ...
        <form className='flex flex-col lg:flex-row lg:gap-x-[10px] gap-y-4'>
          <input className='input bg-transparent placeholder:font-light placeholder:text-white/20 text-white
           focus:ring-1 focus:ring-accent border border-white/20 transition-all'
            type="email"
